...
public class AmazonFireDeviceConnectivityPoller {
    ...
    private final com.test_vpn.AmazonFireDeviceConnectivityPoller.Receiver receiver = new com.test_vpn.AmazonFireDeviceConnectivityPoller.Receiver();
    private final Context context;
    private final com.test_vpn.AmazonFireDeviceConnectivityPoller.ConnectivityChangedCallback callback;

    private final Runnable checker = new com.test_vpn.AmazonFireDeviceConnectivityPoller.PollerTask();
    ...
    AmazonFireDeviceConnectivityPoller(Context context, com.test_vpn.AmazonFireDeviceConnectivityPoller.ConnectivityChangedCallback callback) {
