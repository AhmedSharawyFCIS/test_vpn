...
class NetworkCallbackConnectivityReceiver extends ConnectivityReceiver {
    private final com.test_vpn.NetworkCallbackConnectivityReceiver.ConnectivityNetworkCallback mNetworkCallback;

    public NetworkCallbackConnectivityReceiver(ReactApplicationContext reactContext) {
        super(reactContext);
        mNetworkCallback = new com.test_vpn.NetworkCallbackConnectivityReceiver.ConnectivityNetworkCallback();
    }
